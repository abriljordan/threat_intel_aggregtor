...
class VirusTotalClient(BaseConnector):
    ...
    def _is_valid_hash(self, file_hash):
        ...
        return any(len(file_hash) == length and all(c in '0123456789abcdef' for c in file_hash) for length in hash_lengths.values())
